...
from .evilmanFrames import EVILMANFRAMES
...
##                self.Right = 0 #not needed he will hit a boundery no con-loop
                self.choices()
        if self.direction != "RIGHT":  
            self.RightVarChoice = True
...
class BloodyMess(pygame.sprite.Sprite):
    def __init__(self): 
        ...
        sprite_sheet = SpriteSheet("clownbloodymess.png")
